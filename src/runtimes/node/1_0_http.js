...
// user: call to createServer executed every time a request comes into received on the server
// NB: not every time a connection is made to the server
...
/* added default headers:
    Keep-Alive: timeout=5 = persistent connection to the server. the TCP connection stays alive and is reused.
